#ifndef ECS_COMPONENT_STORAGE_HPP_
#define ECS_COMPONENT_STORAGE_HPP_

#include <ecs/private/sparse_set.hpp>

#include <ecs/component_storage_base.hpp>
...
public:
    using underlying_storage = detail::sparse_set<entity_t>;
